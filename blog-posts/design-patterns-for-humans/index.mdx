...
description: A language agnostic, ultra-simplified explanation to design patterns in TypeScript.
date: May 21, 2022
...
```typescript
const bugger = new BurgerBuilder(14)
  .addCheese()
  .addLettuce()
  .addPepperoni()
  .addTomato()
...
console.log(originalSheep.getName()); // Jolly
console.log(originalSheep.getCategory()); // Mountain Sheep

// Clone and modify what is required
const clonedSheep = originalSheep.clone();
clonedSheep.setName("Dolly");

console.log(clonedSheep.getName()); // Dolly
console.log(clonedSheep.getCategory()); // Mountain Sheep
```

Also you could use the magic method `clone()` to clone the object.
